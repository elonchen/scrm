...
class ZonesControllerTest < ActionController::TestCase
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post :create, zone: { name: @zone.name, parent_zone_id: @zone.parent_zone_id, zone_type: @zone.zone_type }
    end
  ...
  test "should update zone" do
    patch :update, id: @zone, zone: { name: @zone.name, parent_zone_id: @zone.parent_zone_id, zone_type: @zone.zone_type }
    assert_redirected_to zone_path(assigns(:zone))
  end
