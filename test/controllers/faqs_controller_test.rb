...
class FaqsControllerTest < ActionController::TestCase
  ...
  test "should create faq" do
    assert_difference('Faq.count') do
      post :create, faq: { answer: @faq.answer, member_id: @faq.member_id, question: @faq.question, title: @faq.title }
    end
  ...
  test "should update faq" do
    patch :update, id: @faq, faq: { answer: @faq.answer, member_id: @faq.member_id, question: @faq.question, title: @faq.title }
    assert_redirected_to faq_path(assigns(:faq))
  end
